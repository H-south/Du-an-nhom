                ...
                <li class="header__profile-account hide-on-mobile">
                    <div class="header__profile-account-title">
                        <div class="header__profile-account-title-img">
                            <img src="asset/Img/Tri2007.jpg" alt="" class="header__profile-account-title-img-link">
                        </div>
                        <span class="header__profile-account-title-name">Trần Ngọc Trí
                    ...
                    <div class="header__profile-account-menunav">
                        <ul class="header__menunav__list">
                            <div class="header__menunav__list-infor">
                                <img src="asset/Img/Tri2007.jpg" alt="" class="header__menunav__list-infor-img">
                                <div class="header__menunav__list-infor-name">
                                    <p class="header__menunav__list-infor-name-textname">Trần Ngọc Trí</p>
                ...
                <div class="grid wide">
                    ...
                    <div class="container__body-slide1 ">
                        ...
                        <div class="container__body-slide1-main">
                            <img src="asset/Img/slide1/slide1.webp" alt="" class="slide__main-img">
                            <img src="asset/Img/slide1/slide2.webp" alt="" class="slide__main-img">
                            <img src="asset/Img/slide1/slide3.webp" alt="" class="slide__main-img">
                            <img src="asset/Img/slide1/slide4.webp" alt="" class="slide__main-img">
                            <img src="asset/Img/slide1/slide5.webp" alt="" class="slide__main-img">
                        </div>
                        <div class="BtnRight">
                    ...
                    <div class="container__body-content1">
                        <div class="container__body-content1-top">
                            <h2 class="container__content1-tilte">
                                <i class="fa-solid fa-star"></i> Tin tuyển dụng, việc làm tốt nhất
                            </h2>
                                    ...
                                    <div class="container__body-data">
                                        <div class="container__body-data-item">
                                            ...
                                            <div class="container__body-data-item-infor">
                                                <a href="<c:url value='/user/tintuyendung'/>" class="container__body-data-item-infor-position">Nhân viên kinh doanh (Lương từ 15 triệu + doanh thu)</a>
                                                <a href="" class="container__body-data-item-infor-addres">CÔNG TY TNHH Bất Động Sản Sài Gòn Hưng Phát </a>
                                        ...
                                        <div class="container__body-data-bottom">
                                            <div class="container__body-data-bottom-deal">
                                                Trên 15 triệu
                                            </div>
                                ...
                                <div class="col l-4 m-6 c-12 ">
                                    <div class="container__body-data">
                                        <div class="container__body-data-item">
                                            <a class="container__body-data-item-img-link">
                                                <div class="container__body-data-item-img">
                                                    <img src="asset/Img/data/QOpqwW3L8VE3cBaY42HKk4Nfevnm0LSi_1648524019____16f2578ac50f6c150827960767392666.jpg"></img>
                                                </div>
                                            </a>
                                            <div class="container__body-data-item-infor">
                                                <a href="<c:url value='/user/tintuyendung'/>" class="container__body-data-item-infor-position">Chuyên Viên Kinh Doanh Bất Động Sản (Lương Cơ Bản Từ 7 Triệu + Hoa Hồng Cao Nhất Thị Trường)</a>
                                                <a href="#" class="container__body-data-item-infor-addres">CÔNG TY CỔ PHẦN TẬP ĐOÀN SENGROUP </a>
                                                <div class="container__body-data-item-infor-position-sub">
                                ...
                                <div class="col l-4 m-6 c-12 ">
                                    <div class="container__body-data">
                                        <div class="container__body-data-item">
                                            ...
                                            <div class="container__body-data-item-infor">
                                                <a href="TinTuyenDung.html" class="container__body-data-item-infor-position">Nhân viên vận đơn-Trên 25 tuổi (Làm việc online)</a>
                                                <a href="#" class="container__body-data-item-infor-addres">CÔNG TY TNHH CÔNG NGHỆ VÀ DỊCH VỤ ATECH.VN </a>
                                                <div class="container__body-data-item-infor-position-sub">
                                ...
                                <div class="col l-4 m-6 c-12 ">
                                    <div class="container__body-data">
                                        <div class="container__body-data-item">
                                            ...
                                            <div class="container__body-data-item-infor">
                                                <a href="#" class="container__body-data-item-infor-position">Nhân viên kinh doanh FPT</a>
                                                <a href="#" class="container__body-data-item-infor-addres">CÔNG TY TNHH MVP Viễn Thông Quốc Tế FPT </a>
                                                <div class="container__body-data-item-infor-position-sub">
                                ...
                                <div class="col l-4 m-6 c-12 ">
                                    <div class="container__body-data">
                                        <div class="container__body-data-item">
                                            ...
                                            <div class="container__body-data-item-infor">
                                                <a href="#" class="container__body-data-item-infor-position">Giảng viên công nghệ thông tin</a>
                                                <a href="#" class="container__body-data-item-infor-addres">Phân hiệu trường đại học FPT tại thành phố Hồ Chí Minh </a>
                                                <div class="container__body-data-item-infor-position-sub">
                                    ...
                                    <div class="container__body-data">
                                        <div class="container__body-data-item">
                                            ...
                                            <div class="container__body-data-item-infor">
                                                ...
                                                <a href="#" class="container__body-data-item-infor-addres">CÔNG TY CP ĐẦU TƯ VÀ PHÁT TRIỂN BẤT ĐỘNG SẢN THE ONE CORP</a>
                                                <div class="container__body-data-item-infor-position-sub">
                                                    <span>
                                ...
                                <div class="col l-4 m-6 c-12 ">
                                    <div class="container__body-data">
                                        <div class="container__body-data-item">
                                            ...
                                            <div class="container__body-data-item-infor">
                                                <a href="#" class="container__body-data-item-infor-position">Chuyên Viên Kinh Doanh Ngành Nhãn In</a>
                                                <a href="#" class="container__body-data-item-infor-addres">CÔNG TY TNHH CÔNG NGHỆ RAMCO VIỆT NAM </a>
                                                <div class="container__body-data-item-infor-position-sub">
                                ...
                                <div class="col l-4 m-6 c-12 ">
                                    <div class="container__body-data">
                                        <div class="container__body-data-item">
                                            ...
                                            <div class="container__body-data-item-infor">
                                                <a href="#" class="container__body-data-item-infor-position">Trợ Lý E-Commerce Online (Làm Việc Tại Nhà)</a>
                                                <a href="#" class="container__body-data-item-infor-addres">CÔNG TY CỔ PHẦN VIỄN THÔNG TIN HỌC BƯU ĐIỆN </a>
                                                <div class="container__body-data-item-infor-position-sub">
                                ...
                                <div class="col l-4 m-6 c-12 ">
                                    <div class="container__body-data">
                                        <div class="container__body-data-item">
                                            ...
                                            <div class="container__body-data-item-infor">
                                                <a href="#" class="container__body-data-item-infor-position">Nhân Viên Tư Vấn - Không Yêu Cầu Kinh Nghiệm - Thu Nhập Lên Đến 25 Triệu/Tháng</a>
                                                <a href="#" class="container__body-data-item-infor-addres">CÔNG TY TNHH PHÁT TRƯỜNG THỊNH </a>
                                                <div class="container__body-data-item-infor-position-sub">
                                ...
                                <div class="col l-4 m-6 c-12 ">
                                    <div class="container__body-data">
                                        <div class="container__body-data-item">
                                            ...
                                            <div class="container__body-data-item-infor">
                                                <a href="#" class="container__body-data-item-infor-position">Nhân Viên Tư Vấn Đặt Lịch Hẹn Sự Kiện-Telemarketing-Hồ Chí Minh (Không Chốt Sale-Có Đào Tạo-Thu Nhập Cao)</a>
                                                <a href="#" class="container__body-data-item-infor-addres">Công ty TNHH Khu Du Lịch Vịnh Thiên Đường (ALMA) </a>
                                                <div class="container__body-data-item-infor-position-sub">
                                ...
                                <div class="col l-4 m-6 c-12 ">
                                    <div class="container__body-data">
                                        <div class="container__body-data-item">
                                            ...
                                            <div class="container__body-data-item-infor">
                                                <a href="#" class="container__body-data-item-infor-position">Nhân Viên Kinh Doanh (Lương Từ 15 Triệu + Doanh Thu)</a>
                                                <a href="#" class="container__body-data-item-infor-addres">CÔNG TY TNHH BÂT ĐỘNG SẢN SÀI GÒN HƯNG PHÁT </a>
                                                <div class="container__body-data-item-infor-position-sub">
                                                    <span>Nhân Viên Kinh Doanh (Lương Từ 15 Triệu + Doanh Thu)</span>
                                                </div>
                                            </div>
                                ...
                                <div class="col l-4 m-6 c-12 ">
                                    <div class="container__body-data">
                                        <div class="container__body-data-item">
                                            ...
                                            <div class="container__body-data-item-infor">
                                                <a href="#" class="container__body-data-item-infor-position">Trưởng nhóm Content Marketing</a>
                                                <a href="#" class="container__body-data-item-infor-addres">CÔNG TY Cổ Phần Và Công Nghệ Việt Mĩ</a>
                                                <div class="container__body-data-item-infor-position-sub">
                                ...
                                <div class="col l-4 m-6 c-12 ">
                                    <div class="container__body-data">
                                        <div class="container__body-data-item">
                                            ...
                                            <div class="container__body-data-item-infor">
                                                <a href="#" class="container__body-data-item-infor-position">Nhân Viên Kinh Doanh/ Tư Vấn Vật Liệu Nội Thất (HCM/ Đà Nẵng)</a>
                                                <a href="#" class="container__body-data-item-infor-addres">CÔNG TY TRÁCH NHIỆM HỮU HẠN THƯƠNG MẠI DỊCH VỤ XUẤT NHẬP KHẨU A & B </a>
                                                <div class="container__body-data-item-infor-position-sub">
                                ...
                                <div class="col l-4 m-6 c-12 ">
                                    <div class="container__body-data">
                                        <div class="container__body-data-item">
                                            ...
                                            <div class="container__body-data-item-infor">
                                                <a href="#" class="container__body-data-item-infor-position">Nhân Viên Nhập Liệu (Lương Tới 6.000.000Đ/Tháng)</a>
                                                <a href="#" class="container__body-data-item-infor-addres">Phuong Chi Software Company </a>
                                                <div class="container__body-data-item-infor-position-sub">
                                ...
                                <div class="col l-4 m-6 c-12 ">
                                    <div class="container__body-data">
                                        <div class="container__body-data-item">
                                            ...
                                            <div class="container__body-data-item-infor">
                                                <a href="#" class="container__body-data-item-infor-position">Cộng Tác Viên Nhập Dữ Liệu - Trên 24 Tuổi (Làm Việc Online)</a>
                                                <a href="#" class="container__body-data-item-infor-addres">CÔNG TY CỔ PHẦN TRUYỀN THÔNG LONG THÀNH </a>
                                                <div class="container__body-data-item-infor-position-sub">
                                ...
                                <div class="col l-4 m-6 c-12 ">
                                    <div class="container__body-data">
                                        <div class="container__body-data-item">
                                            ...
                                            <div class="container__body-data-item-infor">
                                                <a href="#" class="container__body-data-item-infor-position">Nhân Viên Kinh Doanh (Có Lương Cứng)</a>
                                                <a href="#" class="container__body-data-item-infor-addres">CÔNG TY CỔ PHẦN TPI LAND </a>
                                                <div class="container__body-data-item-infor-position-sub">
                                ...
                                <div class="col l-4 m-6 c-12 ">
                                    <div class="container__body-data">
                                        <div class="container__body-data-item">
                                            ...
                                            <div class="container__body-data-item-infor">
                                                <a href="#" class="container__body-data-item-infor-position">Nhân viên lễ tân</a>
                                                <a href="#" class="container__body-data-item-infor-addres">Công ty Cổ phần Quản lý và Khai thác Tài sản Dầu Khí (PSA) </a>
                                                <div class="container__body-data-item-infor-position-sub">
                                ...
                                <div class="col l-4 m-6 c-12 ">
                                    <div class="container__body-data">
                                        <div class="container__body-data-item">
                                            ...
                                            <div class="container__body-data-item-infor">
                                                <a href="#" class="container__body-data-item-infor-position">Digital Marketing ( Lương Từ 12 Triệu)</a>
                                                <a href="#" class="container__body-data-item-infor-addres">CÔNG TY TNHH IGEA VIỆT NAM </a>
                                                <div class="container__body-data-item-infor-position-sub">
                                ...
                                <div class="col l-4 m-6 c-12 ">
                                    <div class="container__body-data">
                                        <div class="container__body-data-item">
                                            ...
                                            <div class="container__body-data-item-infor">
                                                <a href="#" class="container__body-data-item-infor-position">Giám Sát Dự Án</a>
                                                <a href="#" class="container__body-data-item-infor-addres">CÔNG TY TNHH THƯƠNG MẠI DỊCH VỤ XÂY DỰNG ĐÔNG NAM Á</a>
                                                <div class="container__body-data-item-infor-position-sub">
                                ...
                                <div class="col l-4 m-6 c-12 ">
                                    <div class="container__body-data">
                                        <div class="container__body-data-item">
                                            ...
                                            <div class="container__body-data-item-infor">
                                                <a href="#" class="container__body-data-item-infor-position">Leader SEO - SEO Marketing Leader (Lương 15 - 20 Triệu)</a>
                                                <a href="#" class="container__body-data-item-infor-addres">CÔNG TY CỔ PHẦN SẢN XUẤT VÀ THƯƠNG MẠI PANDA VIỆT </a>
                                                <div class="container__body-data-item-infor-position-sub">
                                ...
                                <div class="col l-4 m-6 c-12 ">
                                    <div class="container__body-data">
                                        <div class="container__body-data-item">
                                            ...
                                            <div class="container__body-data-item-infor">
                                                <a href="#" class="container__body-data-item-infor-position">Kế Toán Tổng Hợp (Lương từ 12tr)</a>
                                                <a href="#" class="container__body-data-item-infor-addres">CÔNG TY TNHH THƯƠNG MẠI VẬN TẠI ANPHA </a>
                                                <div class="container__body-data-item-infor-position-sub">
                                ...
                                <div class="col l-4 m-6 c-12 ">
                                    <div class="container__body-data">
                                        <div class="container__body-data-item">
                                            ...
                                            <div class="container__body-data-item-infor">
                                                <a href="#" class="container__body-data-item-infor-position">Nhân viên chăm sóc khách hàng (Lương cứng từ 10 triệu)</a>
                                                <a href="#" class="container__body-data-item-infor-addres">CÔNG TY CỔ PHẦN MISA </a>
                                                <div class="container__body-data-item-infor-position-sub">
                                ...
                                <div class="col l-4 m-6 c-12 ">
                                    <div class="container__body-data">
                                        <div class="container__body-data-item">
                                            ...
                                            <div class="container__body-data-item-infor">
                                                <a href="#" class="container__body-data-item-infor-position">Tư Vấn Chứng Khoán (Có Nhận Sinh Viên Mới Ra Trường Và Đào Tạo Mới)</a>
                                                <a href="#" class="container__body-data-item-infor-addres">Tài Chính - Chứng Khoán MGlobal </a>
                                                <div class="container__body-data-item-infor-position-sub">
                                ...
                                <div class="col l-4 m-6 c-12 ">
                                    <div class="container__body-data">
                                        <div class="container__body-data-item">
                                            ...
                                            <div class="container__body-data-item-infor">
                                                <a href="#" class="container__body-data-item-infor-position">Trợ Lý Văn Phòng ( Admin Văn Phòng) - Lương Đến 18 Triệu / Tháng Tại Hà Nội</a>
                                                <a href="#" class="container__body-data-item-infor-addres">CÔNG TY CỔ PHẦN THƯƠNG MẠI HỒNG PHÁT </a>
                                                <div class="container__body-data-item-infor-position-sub">
                                ...
                                <div class="col l-4 m-6 c-12 ">
                                    <div class="container__body-data">
                                        <div class="container__body-data-item">
                                            ...
                                            <div class="container__body-data-item-infor">
                                                <a href="#" class="container__body-data-item-infor-position">Nhân viên hỗ trợ ban bảo hiểm trực tuyến</a>
                                                <a href="#" class="container__body-data-item-infor-addres">BẢO HIỂM VIETTINBANK </a>
                                                <div class="container__body-data-item-infor-position-sub">
                                    ...
                                    <div class="container__body-slide2-main-wrap">
                                        <div class="container__body-slide2-item">
                                            <a href="#" class="container__body-slide2-item-link">
                                                <img src="asset/Img/Slide2/1.webp" alt="">
                                            </a>
                                        </div>
                                        <div class="container__body-slide2-item">
                                            <a href="#" class="container__body-slide2-item-link">
                                                <img src="asset/Img/Slide2/2.webp" alt="">
                                            </a>
                                        </div>
                                        <div class="container__body-slide2-item">
                                            <a href="#" class="container__body-slide2-item-link">
                                                <img src="asset/Img/Slide2/3.webp" alt="">
                                            </a>
                                        </div>
                                        <div class="container__body-slide2-item">
                                            <a href="#" class="container__body-slide2-item-link">
                                                <img src="asset/Img/Slide2/4.webp" alt="">
                                            </a>
                                        </div>
                                        <div class="container__body-slide2-item">
                                            <a href="#" class="container__body-slide2-item-link">
                                                <img src="asset/Img/Slide2/5.webp" alt="">
                                            </a>
                                        </div>
                                        <div class="container__body-slide2-item">
                                            <a href="#" class="container__body-slide2-item-link">
                                                <img src="asset/Img/Slide2/6.webp" alt="">
                                            </a>
                                        </div>
                                        <div class="container__body-slide2-item">
                                            <a href="#" class="container__body-slide2-item-link">
                                                <img src="asset/Img/Slide2/7.webp" alt="">
                                            </a>
                                        </div>
                                        <div class="container__body-slide2-item">
                                            <a href="#" class="container__body-slide2-item-link">
                                                <img src="asset/Img/Slide2/8.webp" alt="">
                                            </a>
                                        </div>
                                        <div class="container__body-slide2-item">
                                            <a href="#" class="container__body-slide2-item-link">
                                                <img src="asset/Img/Slide2/9.webp" alt="">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                                ...
                                <div class="container__body-content2-left">
                                    <div class="container__body-left-top">
                                        <h2 class="container__body-left-top-tilte">
                                            <i class="container__body-left-tilte-icon fa-solid fa-heart"></i> Việc Làm Hấp Dẫn
                                        </h2>
                                    </div>
                                    <div class="container__body-left-center">
                                        <div class="container__body-content2-data">
                                            <div class="container__body-content2-item">
                                                ...
                                                <div class="container__body-content2-data-item-infor">
                                                    <a href="#" class="container__body-content2-data-item-infor-position">Kỹ Sư Kinh Doanh Thiết Bị Đo Lưu Lượng Và Thiết Bị Môi Trường</a>
                                                    <a href="#" class="container__body-content2-data-item-infor-addres">CÔNG TY TCỔ PHẦN VISTECH </a>
                                        ...
                                        <div class="container__body-content2-data">
                                            <div class="container__body-content2-item">
                                                ...
                                                <div class="container__body-content2-data-item-infor">
                                                    <a href="#" class="container__body-content2-data-item-infor-position">Kỹ Sư Cơ Khí</a>
                                                    <a href="#" class="container__body-content2-data-item-infor-addres">CÔNG TY TNHH KỸ THUẬT CƠ ĐIỆN LẠNH HOÀNG GIA </a>
                                        ...
                                        <div class="container__body-content2-data">
                                            <div class="container__body-content2-item">
                                                ...
                                                <div class="container__body-content2-data-item-infor">
                                                    <a href="#" class="container__body-content2-data-item-infor-position">Nhân Viên Kinh Doanh - Relationship Manager ( Lcb 15-22Tr)</a>
                                                    <a href="#" class="container__body-content2-data-item-infor-addres">CÔNG TY TNHH BẢO HIỂM NHÂN THỌ AIA (VIỆT NAM)</a>
                                        ...
                                        <div class="container__body-content2-data">
                                            <div class="container__body-content2-item">
                                                ...
                                                <div class="container__body-content2-data-item-infor">
                                                    <a href="#" class="container__body-content2-data-item-infor-position">KMarketing Facebook Ads (Thu Nhập 12 - 25 Triệu)</a>
                                                    <a href="#" class="container__body-content2-data-item-infor-addres">VIỆN THẨM MỸ QUỐC TẾ EVA HÀN QUỐC</a>
                                        ...
                                        <div class="container__body-content2-data">
                                            <div class="container__body-content2-item">
                                                ...
                                                <div class="container__body-content2-data-item-infor">
                                                    <a href="#" class="container__body-content2-data-item-infor-position">Nhân viên Telesale (Ngân hàng OCB - Lương từ 7 triệu)</a>
                                                    <a href="#" class="container__body-content2-data-item-infor-addres">NGÂN HÀNG THƯƠNG MẠI CỔ PHẦN PHƯƠNG ĐÔNG- CHI NHÁNH TÂN BÌNH</a>
                                        ...
                                        <div class="container__body-content2-data">
                                            <div class="container__body-content2-item">
                                                ...
                                                <div class="container__body-content2-data-item-infor">
                                                    <a href="#" class="container__body-content2-data-item-infor-position">Nhân Viên Tư Vấn Chứng Khoán (Không Yêu Cầu Kinh Nghiệm - Lương Từ 10 Đến 30 Triệu)</a>
                                                    <a href="#" class="container__body-content2-data-item-infor-addres">ACE Group </a>
                                        ...
                                        <div class="container__body-content2-data">
                                            <div class="container__body-content2-item">
                                                ...
                                                <div class="container__body-content2-data-item-infor">
                                                    <a href="#" class="container__body-content2-data-item-infor-position">Kỹ Sư Kinh Doanh Hàng Kỹ Thuật (Lương cứng từ 9 triệu)</a>
                                                    <a href="#" class="container__body-content2-data-item-infor-addres">CÔNG TY TNHH KỸ THUẬT TIÊU ĐIỂM</a>
                                    ...
                                    <div class="container__body-left-bottom">
                                        <a href="#" class="container__body-left-top-link-all">>>Xem tất cả</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col l-4 m-6 c-12">
                                <div class="container__body-content2-center">
                                    <div class="container__body-left-top">
                                        <h2 class="container__body-left-top-tilte">
                                            <i class="container__body-left-tilte-icon fa-solid fa-heart"></i> Việc Làm Lương Cao
                                        </h2>
                                    </div>
                                    <div class="container__body-left-center">
                                        <div class="container__body-content2-data">
                                            <div class="container__body-content2-item">
                                                ...
                                                <div class="container__body-content2-data-item-infor">
                                                    <a href="#" class="container__body-content2-data-item-infor-position">Trưởng Nhóm Marketting - Lương từ 10 đến 15 triệu</a>
                                                    <a href="#" class="container__body-content2-data-item-infor-addres">CÔNG TY TNHH BLACK PEARL VIỆT NAM </a>
                                        ...
                                        <div class="container__body-content2-data">
                                            <div class="container__body-content2-item">
                                                ...
                                                <div class="container__body-content2-data-item-infor">
                                                    <a href="#" class="container__body-content2-data-item-infor-position">Nhân viên kinh doanh, lương từ 10 triệu</a>
                                                    <a href="#" class="container__body-content2-data-item-infor-addres">CÔNG TY TNHH SẢN XUẤT KÉT SẮT VIỆT TIỆP VÀ AN TOÀN KHO QUỸ </a>
                                        ...
                                        <div class="container__body-content2-data">
                                            <div class="container__body-content2-item">
                                                ...
                                                <div class="container__body-content2-data-item-infor">
                                                    <a href="#" class="container__body-content2-data-item-infor-position">Nhân Viên Thiết Kế Kiến Trúc (Kiến Trúc Sư) (Architect) (Lương Net Từ 10 - 13 Triệu/Tháng)</a>
                                                    <a href="#" class="container__body-content2-data-item-infor-addres">Công ty cổ phần đầu tư bền vững BIS Việt Nam</a>
                                        ...
                                        <div class="container__body-content2-data">
                                            <div class="container__body-content2-item">
                                                ...
                                                <div class="container__body-content2-data-item-infor">
                                                    <a href="#" class="container__body-content2-data-item-infor-position">Nhân viên tư vấn - Hồ Chí Minh</a>
                                                    <a href="#" class="container__body-content2-data-item-infor-addres">CÔNG TY TNHH A MARKET</a>
                                        ...
                                        <div class="container__body-content2-data">
                                            <div class="container__body-content2-item">
                                                ...
                                                <div class="container__body-content2-data-item-infor">
                                                    <a href="#" class="container__body-content2-data-item-infor-position">Leader Facebook Ads + Lương Cứng 10 Triệu + Thưởng Kpi, Phụ Cấp</a>
                                                    <a href="#" class="container__body-content2-data-item-infor-addres">Công Ty Thời Trang Hafos</a>
                                        ...
                                        <div class="container__body-content2-data">
                                            <div class="container__body-content2-item">
                                                ...
                                                <div class="container__body-content2-data-item-infor">
                                                    <a href="#" class="container__body-content2-data-item-infor-position">Nhân Viên Tư Vấn Bất Động Sản Cao Cấp (Thu Nhập Từ 20 - 100 Triệu/ Tháng)</a>
                                                    <a href="#" class="container__body-content2-data-item-infor-addres">The Connect </a>
                                        ...
                                        <div class="container__body-content2-data">
                                            <div class="container__body-content2-item">
                                                ...
                                                <div class="container__body-content2-data-item-infor">
                                                    <a href="#" class="container__body-content2-data-item-infor-position">Trưởng Phòng Marketing</a>
                                                    <a href="#" class="container__body-content2-data-item-infor-addres">CÔNG TY TNHH SẢN XUẤT KÉT SẮT VIỆT TIỆP VÀ AN TOÀN KHO QUỸ</a>
                            ...
                            <div class="col l-4 m-12 c-12">
                                <div class="container__body-content2-right">
                                    <img src="asset/Img/content2/TopCV tuyển dụng - Right.webp" alt="">
                                </div>
                            </div>
                        </div>
                    </div>

		...
		<div class="header">
			...
			<ul class="header__list hide-on-mobile">
				...
				<li class="header__item header__item-sub3"><a
					href="<c:url value='/user/congty'/>" class="header__item-link">Công Ty</a>
						...
						<div class="col l-6 m-12 c-12">
							<div class="creatCV__container-left">
								<div class="creatCV__container-left-div">
									...
									<a href="#" class="creatCV__container-left-link"> <span>+</span>Tạo
										CV Ngay
									</a>
								</div>
						...
						<div class="col l-6 m-12 c-12">
							<div class="creatCV__container-left">
								<div class="creatCV__container-left-div">
									...
									<a href="#" class="creatCV__container-left-link"> <span><i
										...
										<div class="container__body-data-item">
											...
											<div class="container__body-data-item-infor">
												<a href="TinTuyenDung.html"
													...
													viên kinh doanh (Lương từ 15 triệu + doanh thu)</a> <a href="<c:url value='/user/tintuyendung'/>"
							...
							<div class="selfGrowth-box-item">
								...
								<div class="selfGrowth-box-item-text">
									...
									<p>Cung cấp các khóa học, các kỳ thi giúp ứng viên hiểu rõ
										về xu hướng  và những tiêu chuẩn mới về Năng lực
										chuyên môn</p>
									<div class="selfGrowth-box-item-link">
										<a href="#" class="selfGrowth-box-item-text-link-item">Tìm
											hiểu thêm</a>
					...
					<div class="auth-form__container">
						...
						<form action="/user/dangky" method="post">
							<div class="auth-form__group">
								<input type="text" class="auth-form__input" name="email"
							...
							<div class="auth-form__group">
								<input type="password" class="auth-form__input"
									name="confirmMatKhau" placeholder="Nhập lại mật khẩu">
							</div>
